...
resource "google_compute_firewall" "default" {
  ...
  allow {
    protocol = "tcp"
    ports    = ["80", "443", "8500", "8501", "8502", "8503", "22", "8300", "8301", "8400", "8302", "8600", "4646", "4647", "4648", "8443", "8080", "3000", "3100", "9090"]
  }
  allow {
    protocol = "udp"
...
resource "google_compute_global_address" "https_ip" {
  count = var.dns_zone != "" ? 1 : 0
  name  = "${var.cluster_name}-https-lb-ip"
}
...
# DNS record for Grafana removed - use direct IP access instead

# DNS record for Prometheus removed - use direct IP access instead
